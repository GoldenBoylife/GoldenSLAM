...
using PointType = PointXYZIT;  //포인트 1개 
using PointCloudXYZIT = pcl::PointCloud<PointType>; //포인트 여러개 모인것
using PointCloudXYZITPtr = std::shared_ptr<PointCloudXYZIT>;
using PointCloudXYZITConstPtr = std::shared_ptr<const PointCloudXYZIT>;
